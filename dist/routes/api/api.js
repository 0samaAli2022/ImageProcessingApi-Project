...
exports.isNumber = exports.resizeImage = void 0;
...
routes.get('/', logger_1.default, function (req, res) {
  var imageName = req.query.imageName + '.jpg';
  ...
  var imageLocation = '.\\thumps\\'.concat(height + width + imageName);
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            (0, sharp_1.default)('.\\images\\'.concat(name))
              .resize({
                width: parseInt(w),
                height: parseInt(h),
              })
              .toFile('.\\thumps\\'.concat(h + w + name)),
          ];
        case 1:
          _a.sent();
          return [3 /*break*/, 3];
